export default function Intro() {
  return (
    <div className="flex flex-col items-center justify-center py-20 px-8 scroll-mt-[var(--nav-height)] gap-10">
      ...
      <div className="flex flex-col gap-[34px] text-sm text-center leading-[20px] tracking-[10%]">
        <p>
          OpenHCI 2025 以《Agency 2049》為題 <br/>
          邀請來自資訊、設計、社會科學的學生，一起來挑戰這個問題
        </p>
        <p>
          六天，從一個困惑開始，動手設計出屬於未來的角色與分工
        </p>
        <p>
          現在就加入我們，<br/>
          一起重新定義科技與人的關係
